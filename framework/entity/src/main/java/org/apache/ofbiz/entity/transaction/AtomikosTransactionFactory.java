...
public class AtomikosTransactionFactory implements TransactionFactory {

    public static final String module = AtomikosTransactionFactory.class.getName();

    private static int defaultTransactionTimeoutSeconds = 60;
    private static UserTransactionManager geronimoTransactionManager;
